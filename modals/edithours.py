...
class EditHours(discord.ui.Modal, title="Edit Hours"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            rEmbed = discord.Embed(color=discord.Color.red(), title="Edit Hours", description=f"Error: Failed to edit hour request because {self.time.value} is not a number. Please input a valid number.\n\nFull error:{e}")
